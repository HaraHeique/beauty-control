...
namespace BeautyControl.API.Features.Products.DeleteProductImage
{
        ...
        .WithActionResult
    {
        ...
        [SwaggerOperation(
            Summary = "Remover a imagem de um dado produto.",
            Description = "Remove uma image atrelado a um produto existente na base de dados.",
            OperationId = "Products.DeleteProductImage",
