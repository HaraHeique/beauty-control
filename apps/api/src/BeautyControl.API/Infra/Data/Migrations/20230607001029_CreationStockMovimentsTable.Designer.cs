...
namespace BeautyControl.API.Infra.Data.Migrations
{
    ...
    [Migration("20230607001029_CreationStockMovimentsTable")]
    partial class CreationStockMovimentsTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BeautyControl.API.Domain.StockMovements.StockMovements", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BeautyControl.API.Domain.Suppliers.Supplier", b =>
                {
                    b.OwnsOne("BeautyControl.API.Domain.Suppliers.Telephone", "Telephone", b1 =>
                        {
